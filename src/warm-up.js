...
var sequel = `${title} Has Big Secrets`;
...
var books = ['1984', 'Follow The River', 'Harry Potter', 'Moby Dick', 'Dark Matter'];
...
var belowTwoHundred = [1, 5, 9, 164, 14, 199, 46, 23, 3, 98, 111, 98];
...
var dictionary = {
  name: "Webster's", //I noticed here using 'Webster's' caused a syntax error in the terminal...but double quotes fixed it.
  hasThesaurus: false,
}
